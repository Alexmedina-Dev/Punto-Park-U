...
export function Modal({ open, onClose, title, children, footer }: ModalProps) {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className="fixed w-full max-w-md md:max-w-2xl lg:max-w-3xl bg-surface-container border border-outline/20 rounded-t-2xl md:rounded-lg shadow-brutal animate-in fade-in zoom-in-95 md:zoom-in-100 max-h-[90vh] overflow-y-auto z-10
